defmodule RockPaperScissors do
  ...
  def get_computer_pick({player_score, computer_score, player_pick}), do: {player_score, computer_score, player_pick, random_number(3)}
  ...
  def write_data(round, atoms, value), do: IO.inspect put_in(round, atoms, value)
  def retrieve_data(round, atoms), do: IO.inspect get_in(round, atoms)
