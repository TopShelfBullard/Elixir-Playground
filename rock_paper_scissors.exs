defmodule RockPaperScissors do
  def get_player_pick({player_score, computer_score}) do
    parse_player_pick({player_score, computer_score, IO.gets(Output.choices)})
  end
  ...
  def get_computer_pick({player_score, computer_score, player_pick}) do
    {player_score, computer_score, player_pick, Utilities.random_number(3)}
  end
  ...
  def play_game({5, _}), do: Output.player_ultimate_victory
  def play_game({_, 5}), do: Output.computer_ultimate_victory
